export default function Skeleton() {
  return (
    <div className="w-full m-auto px-8 py-12">
      ...
      <div
        role="status"
        className="max-w-5xl p-4 animate-pulse md:p-6 dark:border-gray-700"
      >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4">
        <div
          role="status"
          className="max-w-sm p-4 border border-gray-300 rounded shadow animate-pulse md:p-6 dark:border-gray-700"
        >
